...
namespace math{
template void nested_sum<float,math::Vector2f>(eig::MatrixXf& summed, const math::MatrixXv2f& field);
template void nested_sum<float,math::Matrix2f>(eig::MatrixXf& summed, const math::MatrixXm2f& field);
template void nested_sum<float,math::Vector3f>(math::Tensor3f& summed, const math::Tensor3v3f& field);
