...
void Optimizer2d::SharedParameters::set_from_json(pt::ptree root) {
	...
	this->enable_convergence_reporting = root.get<bool>("enable_energy_and_min_vector_logging", false);
...
void Optimizer2d::SharedParameters::set_from_values(float gradient_descent_rate,
	...
	this->enable_convergence_reporting = enable_energy_and_min_vector_logging;
