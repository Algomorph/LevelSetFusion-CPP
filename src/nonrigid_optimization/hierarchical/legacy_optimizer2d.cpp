...
#include "legacy_optimizer2d.hpp"
...
LegacyOptimizer2d::LegacyOptimizer2d(
...
LegacyOptimizer2d::VerbosityParameters::VerbosityParameters(
...
LegacyOptimizer2d::LoggingParameters::LoggingParameters(bool collect_per_level_convergence_reports) :
		collect_per_level_convergence_reports(collect_per_level_convergence_reports) {
}


math::MatrixXv2f LegacyOptimizer2d::optimize(eig::MatrixXf canonical_field, eig::MatrixXf live_field) {
...
void LegacyOptimizer2d::optimize_level(
...
bool LegacyOptimizer2d::termination_conditions_reached(float maximum_warp_update_length,
...
void LegacyOptimizer2d::clear_logs(){
	this->per_level_convergence_reports.clear();
}

std::vector<telemetry::ConvergenceReport> LegacyOptimizer2d::get_per_level_convergence_reports(){
